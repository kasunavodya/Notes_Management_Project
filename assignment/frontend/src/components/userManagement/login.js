...
export default class Login extends Component {
    ...
    /**
    * DESCRIPTION       -       The function written to login to the system
    ...
    */
    ...
    render() {
        return (
            <div>
                <Header />
                <div class="login__container" style={{ marginTop: '-40px' }}>
                        ...
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div class="m-t-lg">
                                <ul class="list-inline">
                                    ...
                                    <li><br />
                                        <a class="forgotPW__link" href="/forgotPassword" style={{ color: "#72beed", fontSize: "15px" }}>Forgot Password</a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;     &nbsp;&nbsp;&nbsp;      &nbsp;&nbsp;&nbsp;     &nbsp;&nbsp;&nbsp;

                                        <a class="signup__link" href="/register" style={{ color: "#72beed", fontSize: "15px" }}>Sign-Up</a>
                                    </li>
                                </ul>
                            </div>
