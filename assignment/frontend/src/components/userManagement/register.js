...
export default class register extends Component {
    ...
    render() {
        return (
            <div>
                <Header />
                <div class="signup__container" style={{ marginTop: '-110px' }}>
                    ...
                    <div class="container__child signup__form">
                        <form onSubmit={this.onSubmit}>
                            <div class="form-group">
                                <b><label for="username">Full Name</label></b>
                                <input
                            ...
                            <div class="form-group">
                                <b><label for="passwordRepeat">Confirm Password</label></b>
                                <input
                                    style={{ backgroundColor: "white" }}
                                    class="form-control"
                                    type="password"
                            ...
                            <div class="m-t-lg">
                                <ul class="list-inline">
                                    ...
                                    <li><br />
                                        <a class="signup__link" href="/" style={{ color: "#72beed", fontSize: "15px" }}>I am already a member</a>
                                    </li>
                                </ul>
                            </div>
                        </form>
